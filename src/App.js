...
class ConnectedComponents extends Component {
    ...
    layout(components) {
        ...
        const withOffsetsAndScaled = flattened.map((c) => {
            return {
                ...c,
                startX: (xScale * c.startX),
                startY: ((xScale * c.startY) + background.height),
                startWidth: (xScale * c.width),
                startHeight: (xScale * c.height),
            }
        });
        ...
        return (
            <div className="biscuits">
                <div className="original">
                    <img src={`data/${this.props.name}.png`} alt="original" onClick={this.toggle}/>
                </div>
                <div className="components">
                    {
                        this.state.components.map((component, index) => {
                            ...
                            const url = `data/${this.props.name}.label_${component.id}.png`;
